...
const translations = {
  zh: {
    ...
    settingsAiEnvConfiguredBadge: "来自环境变量",
    settingsAiDbPersistHint: "填写后将保存至数据库",
    ...
    chatOverlayDismiss: "忽略",
    chatOverlayConfirm: "确认保存",
    chatOverlayPendingCount: (variables?: TemplateVariables) =>
      `发现 ${variables?.count ?? 0} 条待处理档案操作`,
    chatOverlayThinking: "正在思考",
    chatOverlayAnalysisSummary: "分析摘要",
    chatDraftConfirmed: "已保存",
    chatDraftDismissed: "已忽略",
    chatActionCreate: "新增",
    chatActionUpdate: "更新",
    chatActionDelete: "删除",
    chatResourceObservation: "指标记录",
    chatResourceCondition: "健康状况",
    chatResourceMedication: "用药记录",
    chatResourceEncounter: "就诊记录",
    chatErrorProcessing: "处理请求时发生错误，请重试",
  },
  en: {
    ...
    settingsAiEnvConfiguredBadge: "From environment",
    settingsAiDbPersistHint: "Values you enter will be saved to the database.",
    ...
    chatOverlayDismiss: "Dismiss",
    chatOverlayConfirm: "Save",
    chatOverlayPendingCount: (variables?: TemplateVariables) =>
      `${variables?.count ?? 0} pending health record operation(s)`,
    chatOverlayThinking: "Thinking",
    chatOverlayAnalysisSummary: "Analysis summary",
    chatDraftConfirmed: "Saved",
    chatDraftDismissed: "Dismissed",
    chatActionCreate: "Add",
    chatActionUpdate: "Update",
    chatActionDelete: "Delete",
    chatResourceObservation: "Health metric",
    chatResourceCondition: "Condition",
    chatResourceMedication: "Medication",
    chatResourceEncounter: "Visit",
    chatErrorProcessing: "Error processing request, please try again",
  },
} as const;
