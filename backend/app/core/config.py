...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        local_whisper_model=os.getenv("KINCARE_LOCAL_WHISPER_MODEL", "whisper-large-v3-turbo"),
        ...
        local_whisper_download_root=os.getenv("KINCARE_LOCAL_WHISPER_DOWNLOAD_ROOT"),
