...
def client(monkeypatch: pytest.MonkeyPatch, tmp_path: Any) -> TestClient:
    ...
    monkeypatch.setenv("KINCARE_JWT_SECRET", "phase-4-test-secret")
    ...
    monkeypatch.setenv("KINCARE_SCHEDULER_ENABLED", "1")
...
def custom_schedule_client(monkeypatch: pytest.MonkeyPatch, tmp_path: Any) -> TestClient:
    ...
    monkeypatch.setenv("KINCARE_AI_MODEL", "test-model")
    monkeypatch.setenv("KINCARE_SCHEDULER_ENABLED", "1")
    monkeypatch.setenv("KINCARE_HEALTH_SUMMARY_REFRESH_HOUR", "4")
    monkeypatch.setenv("KINCARE_HEALTH_SUMMARY_REFRESH_MINUTE", "15")
    monkeypatch.setenv("KINCARE_CARE_PLAN_REFRESH_HOUR", "6")
    monkeypatch.setenv("KINCARE_CARE_PLAN_REFRESH_MINUTE", "45")
